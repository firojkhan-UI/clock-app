...
const Clock = props => {
  ...
  const hoursDegrees = clock.date.getHours() + `${props.timeDiff}` * 30 + clock.date.getMinutes() / 2;
  // const hoursDegrees = clock.date.setHours(clock.date.getHours() * 30 + clock.date.getMinutes()/2)
  console.log(hoursDegrees,'hrs')
  const minutesDegrees = clock.date.getMinutes() * 6 + clock.date.getSeconds() / 10;
  console.log(minutesDegrees,'Minuts')
  const secondsDegrees = clock.date.getSeconds() * 6;
  console.log(secondsDegrees,'second')
  const divStyleHours = {
    // transform: `rotatez + ${hoursDegrees} + deg` 
    transform: "rotateZ(" + hoursDegrees + "deg)"
  };
// console.log(clock.date.getHours() * 6 + clock.date.getSeconds() / 10,'HAHAHHAH')
      ...
      <div id="clock" className="clock-content">
        ...
        <div
          ...
          className={
            ...
            (clock.date.getMinutes() === 0 ? "" : "transition-effect")
          }
        ...
        <div
          ...
          className={
            ...
            (clock.date.getSeconds() === 0 ? "" : "transition-effect")
          }
